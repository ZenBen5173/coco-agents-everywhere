      ...
      >
        ...
        >
          <svg width={size} height={size} className="-rotate-90">
            {segments.map((seg, i) => {
              // A zero segment still paints: strokeLinecap="round" turns a
              // zero-length dash into a dot, so an empty category showed as a
              // stray blob behind the ring. Skip the arc, keep the legend row.
        ...
        {data.map((v, i) => {
          ...
          return (
            ...
            <div className="relative h-full flex-1 cursor-default">
              {v === 0 ? (
                // An empty day gets a flat baseline tick and no animation.
                // Breathing it between 0% and 9% made nothing look like
                // something, and caught mid-pulse the empty days disagreed
                // with each other — some a line, some a dot.
                <span
